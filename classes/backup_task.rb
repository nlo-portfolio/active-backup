...
#   @interval        (Integer):  time in seconds between backups.
#   @local_copy      (Boolean):  keep a local copy or delete.
#   @paths           (Array):    the file systems paths to backup.
#   @next_backup     (Time):     time of the next backup.
#   @current_backup  (Integer):  current backup iteration (count).
#
class BackupTask
