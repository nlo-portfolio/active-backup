...
class ArhiveUtilsTest < Test::Unit::TestCase
  ...
  def test_compression_should_pass
    ...
    z.close
    assert_equal decompressed.string, Fixtures.test_plaintext
  end
  ...
  def test_archive_should_pass
    archive_io = ArchiveUtils.archive [Fixtures.fixtures_base + '/test_dir_official']
    ...
    FileUtils.rm_r Fixtures.temp_base + '/test_dir'
  end
  ...
  def test_unpack_decrypt_only_should_pass
    ...
    File.delete options.output_filename
  end
  ...
  def test_unpack_all_should_pass
    ...
    #Dir.rmdir options.output_filename
    #FileUtils.rm_r options.output_filename
  end
end
